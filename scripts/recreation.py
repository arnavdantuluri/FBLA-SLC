...
#recreation callback to return the type of activity chosen by the user
def recreation_callback(selection):
    global attraction
...
def run():
    ...
    #Recreation Dropdown
    recreation_dropdown_menu = OptionMenu(root, variable,'Water Sports', "Hiking",  "Camping", "Rock Climbing", "Cruise", command=recreation_callback)
...
def display_map():
    ...
    folium.Marker([latitude, longitude], popup="<h1> Recreational Activity </h1>").add_to(m)
    m.save('recreation_map.html')